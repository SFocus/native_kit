...
/// Type-safe icon representation for NKTabBar items.
///
/// Supports SF Symbols (iOS) only.
@immutable
sealed class NKTabBarIcon {
  const NKTabBarIcon();

  /// Converts the icon to a map for platform channel communication.
...
class NKSFSymbol extends NKTabBarIcon {
  /// The SF Symbol name.
  final String name;
